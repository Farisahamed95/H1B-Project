...
show_menu
    ...
    if [[ $opt = "" ]]; then 
		...
		hadoop jar First.jar task1a /niit6/proj /niit5/projop3
	...
	5) clear;
	    ...
	    hadoop jar First.jar task3 /niit6/proj /niit5/projop4
	    hadoop fs -cat /niit5/projop4/p*
       show_menu;
        ;;
	...
	10) clear;
	    ...
	    hive -e "use project; select year, count(*) from h1b_final group by year;"
        show_menu;
        ;;
	...
	11) clear;
	    ...
	    case $n in
                1)	echo "Full time"
                    pig -x local query8a.pig
                    ;;		
                    
                2) 	echo "Part time"
                   pig -x local query8b.pig
                    ;;
