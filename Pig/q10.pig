...
data1 = LOAD 'hdfs://localhost:54310/user/hive/warehouse/h1b.db/h1b_final' USING PigStorage('\t') as (s_no:double,case_status:chararray,employer_name:chararray,soc_name:chararray,job_title:chararray,full_time_position:chararray,prevailing_wage:double,year:chararray,worksite:chararray,longitude,latitude);
...
dump data14;
--store data14 into '/home/hduser/niit1/Pig1/question10' using PigStorage('\t');
